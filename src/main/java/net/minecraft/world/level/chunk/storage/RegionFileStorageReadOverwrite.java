...
public class RegionFileStorageReadOverwrite {
    ...
    @Nullable
    public static CompoundTag read(@NotNull Object storage,
                                   @NotNull ChunkPos pos, @NotNull RegionFile regionfile) throws Throwable {
    ...
    public static MethodHandle resolve(@NotNull Class<?> clazz, @NotNull String methodName,
